...
the evaluated code: see the [verification record](source-verification.json).
...
`benchmarks/encouragement/comparison-results/`. The [primary pointwise table](pointwise.csv)
and [secondary pointwise table](correlated-pointwise.csv) retain
