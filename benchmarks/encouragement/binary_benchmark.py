...
def run(args):
    ...
    config = BinaryConfig(trees=args.trees, marginal_uptake_refresh=args.marginal_uptake_refresh)
...
def main():
    ...
    parser.add_argument("--marginal-uptake-refresh", action="store_true")
